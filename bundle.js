...
(function () {
    ...
    var ModelSync = (function () {
        ...
        _createClass(ModelSync, [{
            key: 'eventMonitor',
            value: function eventMonitor(spec, val, source) {
                if (spec.op() == 'init') {
            ...
            key: 'textInitialized',
            value: function textInitialized() {
...
},{"./data_types/model.js":2,"swarm":5}],2:[function(require,module,exports){
"use strict";

var swarm = require('swarm'),
    Model = swarm.Model.extend('Model', {
    text: 'Initial Value'
});

module.exports = Model;

},{"swarm":5}],3:[function(require,module,exports){
"use strict";
...
},{"./Host":4,"./LevelStorage":6,"./LongSpec":7,"./Model":8,"./Pipe":9,"./ReactMixin":11,"./Set":13,"./SharedWebStorage":14,"./Spec":15,"./Storage":16,"./Syncable":17,"./Vector":18,"./WebSocketStream":19,"./env":20}],6:[function(require,module,exports){
"use strict";
var env = require('./env');
var Spec = require('./Spec');
...
},{"./Spec":15,"./Storage":16,"./env":20}],7:[function(require,module,exports){
"use strict";
